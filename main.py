	...
	if(a=='0'):
		...
		with sr.Microphone() as source:
			...
			try:
				...
				elif text.find('see')!=-1 or text.find('dekh')!=-1 or text.find('scene')!=-1 : 
					engine = pyttsx3.init()
					engine.setProperty('voice', 'hindi')
					rate = engine.getProperty('rate')
					engine.setProperty('rate', rate-20)
					engine.say("Please hold the Camera still")
					engine.runAndWait()
					print("Please hold the Camera still")
					time.sleep(3)
					os.system("python /home/fizzing/AI/minor2/try-last-day/images/capture.py")
					os.system("python /home/fizzing/AI/minor2/try-last-day/pytorch-tutorial/tutorials/03-advanced/image_captioning/sample.py --image='/home/fizzing/AI/minor2/try-last-day/images/captured.jpg'")
